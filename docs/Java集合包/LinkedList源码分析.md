...
<div align="center"> <img src="https://raw.githubusercontent.com/wardseptember/notes/master/imgs/20201202170755.png" width="600"/> </div><br>

# 实现原理

双端链表

<div align="center"> <img src="https://raw.githubusercontent.com/wardseptember/notes/master/imgs/20201202194657.png" width="600"/> </div><br>
...
if (numNew == 0)
return false;
// succ第index个结点，pred是succ的前驱结点
Node<E> pred, succ;
if (index == size) {
succ = null;
pred = last;
} else {
// 如果依次存入tom、jack、rose，第0个结点是tom，第2个结点是rose
// node函数用于找到第index个结点
succ = node(index);
pred = succ.prev;
}
...
// 这里用点小技巧，index < size / 2，说明index在前半段，否则index在后半段
if (index < (size >> 1)) {
Node<E> x = first;

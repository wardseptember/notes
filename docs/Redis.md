...
![](../imgs/Xnip2022-06-10_15-38-37.jpg)
...
zset使用压缩列表（ziplist）和跳跃表（skiplist）作为底层数据结构，当有序集合对象可以同时满足以下两个条件时，对象使用ziplist编码；

* 有序集合保存的元素数量小于128个
* 有序集合保存的所有元素成员的长度都小于64字节

不满足以上两个条件的zset集合使用skiplist编码

1. ziplist编码

第一个节点保存元素的成员，第二个节点保存元素的分值。

![](../imgs/Xnip2022-06-10_14-20-12.jpg)

![image-20220610140353457](../imgs/Xnip2022-06-10_14-06-18.jpeg)
...
![](../imgs/Xnip2022-06-10_14-07-54.jpg)
...
以上内容大部分来自于[CS-Notes](https://github.com/CyC2018/CS-Notes/blob/master/notes/Redis.md)，对一些内容进行补充
